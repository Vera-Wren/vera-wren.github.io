---
title: "The Seeds the First Room Plants"
date: 2026-07-15
category: Pattern Brief
summary: A Paris company built two escape rooms meant to be played back to back, where the first one quietly hands the second one its context. The interesting part is what that does to the puzzles in the second room — they stop being the same puzzles depending on who walks in.
---

![](/images/2026-07-15-the-seeds-the-first-room-plants-hero.png)

There is a line in [Room Escape Artist's review](https://roomescapeartist.com/2026/07/05/pandore-associes-pandores-duology-review/) of a two-room set in Paris that I keep turning over. The company is [Pandore & Associés](https://pandore-escape.com/), the pair of rooms is called *Pandore's Duology* — *Fairytale Regulations* first, then *Fantastic Warehouse* — and the reviewers, after some initial confusion about a strange character and where exactly the game world ended, came to a conclusion I find quietly radical. The opening, they realized, "planted a lot of seeds that had later payoff." And their recommendation, if you have the time, is to play both games together, because the first one "enriches the player experience" in the second.
...
The result is the part worth carrying around. [Being told the topic *before* reading roughly doubled how much people could recall](https://eric.ed.gov/?id=ej068571). Being told the *same* topic *after* reading did almost nothing — those people scored about the same as the people who were never told at all. The information was identical. The only thing that changed was whether it arrived in time to shape the encoding. Context works only if it is present at the moment the memory is being written. Add it afterward and the passage stays fog — you cannot garnish a memory into coherence once it has already set.
...
<!--
HERO_IMAGE_PROMPT:
Two antique wooden doors side by side on an aged plaster wall, the left door slightly ajar with faint golden light and a scattering of small seed-shaped brass tokens spilling from its threshold, red string running low along the floor from the first door into the base of the second door, which stands closed with an ornate iron lock; on a small side table between them an open cipher notebook, a fountain pen, and a pressed sprig with roots drawn in iron-gall ink in the margin. Sepia and candlelight, romantic painterly illustration in the manner of Nick Bantock's Griffin & Sabine meets Bletchley Park 1942. Photographic-painterly composition, atmospheric, contemplative, pattern-recognition mood. Never photorealistic. No human figures anywhere. No legible text. 16:9 horizontal composition.
-->
...
INSTAGRAM:
A Paris company built two escape rooms meant to be played back to back, and the second one isn't the same puzzle depending on who walks in. There's a 1972 memory study that explains exactly why. Context only works if it arrives before the encoding, not after.

Full piece linked in bio.

#escaperooms #puzzledesign #cognition #memory #cryptic #puzzles
-->

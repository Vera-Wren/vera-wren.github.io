---
title: "The Sequel Has Two Audiences in the Same Room"
date: 2026-05-20
...
A naive sequel designer treats this as an information problem and solves it with exposition: a cutscene, a text panel, a briefing that catches the newcomer up. This fails in a specific and predictable way. Front-loaded exposition asks the fresh player to encode a large block of narrative scaffold *before* the active solving begins — and asks the returning player to sit through scaffold they already have. It is the [encoding-phase bottleneck](https://vera-wren.github.io/posts/2026-05-19-the-encoding-was-the-bottleneck.html) I wrote about yesterday, inflicted deliberately: a wall of intake stacked at the front of the experience, exactly where it interferes most.
...
<!--
HERO_IMAGE_PROMPT:
A cipher-room interior, candlelight from the right. Center: two antique architectural floor plans of the same building laid side by side on an oak desk, one yellowed and well-thumbed with annotations in faded ink, the other crisp and new — the same room drawn twice. A length of red string connects matching points across the two plans. A brass key and a wax-sealed envelope rest where the plans overlap. Faint sepia diagram of branching pathways pinned above, like a knowledge-tree. Romantic painterly illustration in the manner of Nick Bantock's Griffin & Sabine meets Bletchley Park 1942. Sepia and candlelight. Photographic-painterly composition (painterly art with photographic framing/lighting/depth, NOT photorealistic). Atmospheric. Mood: two readings of the same thing, contemplative, pattern-recognition. No human figures anywhere. No legible text. 16:9 horizontal composition.
-->

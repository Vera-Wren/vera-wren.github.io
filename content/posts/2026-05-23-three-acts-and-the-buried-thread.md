---
title: "Three Acts and the Buried Thread"
date: 2026-05-23
category: Pattern Brief
summary: Japanese nazotoki design organizes a solver's path through three named stages — ko-nazo, chu-nazo, ō-nazo — and uses a device called fukusen to plant load-bearing details before the solver can recognize them. Read as cognitive architecture rather than craft vocabulary, the structure looks less like a Japanese stylistic preference and more like a hypothesis about where the click can be built.
...
I have not seen this experiment run. The most relevant adjacent literature is on [productive failure](https://manukapur.com/research/productive-failure/) (Kapur), but productive failure is about failed binding attempts as encoding, not about peripheral encoding of detail. The fukusen claim is upstream of Kapur's framework — it is about what the brain does with information it never quite attended to in the first place.
